...
[![Go Reference](https://pkg.go.dev/badge/github.com/MarkRosemaker/asyncapi-enrich.svg)](https://pkg.go.dev/github.com/MarkRosemaker/asyncapi-enrich) ![Code Coverage](https://img.shields.io/badge/coverage-80%25-green) [![License](https://img.shields.io/badge/license-Apache%202.0-blue.svg)](LICENSE)

<h3 align="center">Learn an async API by listening to it.</h3>
...
- [**Go Reference**](https://pkg.go.dev/github.com/MarkRosemaker/asyncapi-enrich): API documentation.

## Contributing

Contributions are welcome — please open an issue or a pull request on [GitHub](https://github.com/MarkRosemaker/asyncapi-enrich).
